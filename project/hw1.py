...
numerator_0 = abs(w[0]*mean_g0[0] + w[1]*mean_g0[1] + clf.intercept_[0])
numerator_1 = abs(w[0]*mean_g0[0] + w[1]*mean_g1[1] - clf.intercept_[0])

dist_0 = numerator_0/denominator
dist_1 = numerator_1/denominator
